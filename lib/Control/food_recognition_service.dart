...
class FoodRecognitionService {
  ...
  Future<bool> initialize() async {
    ...
    try {
      ...
      debugPrint('FoodRecognitionService: TFLite desactivado, usando modo demo');
  ...
  Future<Map<String, dynamic>?> _analyzeWithAPI(XFile xFile) async {
    try {
      ...
      final detectedFoods = [
        ...
        'pizza', 'hamburguesa', 'ensalada', 'sushi', 'carne'
      ];
      ...
      if (nutritionData != null) {
        debugPrint('FoodRecognition: Found nutrition data: ${nutritionData.source} (${(nutritionData.confidence * 100).toStringAsFixed(0)}% confidence)');
